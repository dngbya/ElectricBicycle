<template>
  ...
  <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" v-if="accountLogin">
    ...
    <div style="display: flex">
            <div style="flex: 1">还没有账号？请 <span style="color: #110f98; cursor: pointer" @click="toRegister">注册</span></div>
          </div>
  </el-form>
  <Register v-else @account="account"/>
</template>

        ...
        <el-card class="box-card" style="height: 100%">
          ...
          <div class="personal">
            ...
            <div class="list">
              ...
              <div>年龄：21</div>
              <div>性别：女</div>
              <div>现住址：中国-江西-南昌</div>
              <div>邮箱：2934956283@qq.com</div>
              <div>微信：19047918657(欢迎加微信入群)</div>
            ...
            <div>
              ...
              <el-tag style="margin-right: 10px">追星</el-tag>
              <el-tag style="margin-right: 10px">睡觉</el-tag>
              <el-tag style="margin-right: 10px">电影</el-tag>
              <el-tag>向往</el-tag>
            </div>
            <el-divider></el-divider>
...
<script setup lang="ts">
  ...
  import weLogo from '@/assets/image/we.jpg'
